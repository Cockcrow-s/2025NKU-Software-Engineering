...
# 文件路径
AUDIO_FOLDER = "audio"
OUTPUT_FILE = "data/speechinstruction.txt"
DATALOG_FILE = "data/datalog.txt"  
...
class AudioProcessor:
    ...
    def batch_process(self, audio_files: List[str]) -> Dict[str, Dict[str, Any]]:
        ...
        for idx, file_path in enumerate(audio_files, 1):
            ...
            current_time = time.strftime("%Y-%m-%d %H:%M:%S")  # 获取时间
