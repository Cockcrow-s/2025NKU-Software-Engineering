...
def process_file(input_file):
    ...
    # 处理日志写入
    with open('CarSoft/feedbacklog.txt', 'a', encoding='utf-8') as log_f:
    ...
    # 结果写入
    with open('CarSoft/feedback1.txt', 'w', encoding='utf-8') as f1:
        f1.write('\n'.join(feedback1))
    
    with open('CarSoft/feedback2.txt', 'w', encoding='utf-8') as f2:
        f2.write('\n'.join(feedback2))

def extract_content():
    input_file = "CarSoft/infer.txt"
