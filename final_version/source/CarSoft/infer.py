...
def content_infer():
    ...
    config = {
        "device": "gpu",
        "model_path": "CarSoft/premodel/model/trained/",
        "infer_prefix": "CarSoft/premodel/model/infer_model",
        "test_path": "CarSoft/data/speechinstruction.txt",
        "intent_label_path": "CarSoft/data/intent_label.txt",
        "slot_label_path": "CarSoft/data/slot_label.txt",
        "max_seq_length": 16,
        "batch_size": 512,  
        "output_file": "CarSoft/infer.txt"
    }
